var client = algoliasearch('AZK0SCC3JD', '3a172d1a1d1731445c44a943fbb4a8b2');
var requestIndex = client.initIndex('requestIndex');

// const requestIndex = apiClient.initIndex('requests');
// requestIndex
//   .addObject({
//     firstname: 'Doug',
//     lastname: 'Dimmadome',
